...
export async function getStaticProps({ params }) {
    ...
    let featuredImageUrl = "https://dev-headless-next.pantheonsite.io/wp-content/uploads/2022/12/travel_icy-polar_022K.jpg";
...
export default function Post({ postData, featuredImageUrl, comments, commentCount, seoData }) {
    ...
    const frontendBlogBase = `${process.env.NEXT_PUBLIC_SITE_URL || 'http://localhost:3000'}/blog`;
    const wpOriginPattern = /https:\/\/dev-headless-next\.pantheonsite\.io(?!\/wp-content\/uploads)/g;
    let jsonSchema = seoData.schema.raw.replace(wpOriginPattern, frontendBlogBase);
